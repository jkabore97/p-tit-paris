...
export function CartBar() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-4 z-40 flex justify-center px-4">
      <Link
        href="/commander"
        className="animate-pop btn-shine flex w-full max-w-md items-center justify-between gap-4 rounded-full bg-ink px-6 py-3.5 text-white shadow-2xl shadow-ink/30 transition hover:-translate-y-0.5"
      >
